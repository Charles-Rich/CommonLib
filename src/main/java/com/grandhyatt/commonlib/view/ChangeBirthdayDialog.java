...
import com.grandhyatt.commonlib.view.wheelview.OnWheelChangedListener;
import com.grandhyatt.commonlib.view.wheelview.OnWheelScrollListener;
import com.grandhyatt.commonlib.view.wheelview.WheelView;
import com.grandhyatt.commonlib.view.wheelview.adapter.AbstractWheelTextAdapter;
...
public class ChangeBirthdayDialog extends Dialog implements View.OnClickListener {
	...
	private int mInt_Years = -1;

	private OnBirthdayListener onBirthdayListener;

	public ChangeBirthdayDialog(Context context,int initYears) {
		super(context, R.style.BirthdayDialog);
		this.context = context;
		this.mInt_Years = initYears;
	}
...
//		for (int i = getYear(); i > getYear() - 13; i--) {
//			arry_years.add(i + "");
//		}
	}
	...
	private class CalendarTextAdapter extends AbstractWheelTextAdapter {
		...
		protected CalendarTextAdapter(Context context, ArrayList<String> list, int currentItem, int maxsize, int minsize) {
			super(context, R.layout.view_item_birthday_year, NO_RESOURCE, currentItem, maxsize, minsize);
			this.list = list;
	...
	public void setBirthdayListener(OnBirthdayListener onBirthListener) {
		this.onBirthdayListener = onBirthListener;
	}
	...
	public void onClick(View v) {
		...
		if (v == btnSure) {
			if (onBirthdayListener != null) {
				onBirthdayListener.onClick(selectYear, selectMonth, selectDay);
			}
		} else if (v == btnSure) {
